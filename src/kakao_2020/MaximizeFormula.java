...
public class MaximizeFormula {
	...
	public static void main(String[] args) {
		String expression = "100-200*300-500+20";	// return : 60420
//		String expression = "50*6-3*2";				// return : 300
//		물회 어죽 미역국 수육 부침개 광어회
		System.out.println(new MaximizeFormula().solution(expression));
	}
}
