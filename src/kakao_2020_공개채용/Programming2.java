...
public class Programming2 {
        ...
        for(int k = 0; k < course.length; k++) {
        	...
        	for(int i = 0; i < orders.length; i++) {
        		...
        		for(int j = 0; j < orders[i].length(); j++) {
        			arr.add(orders[i].charAt(j));
        		}
        		combination(arr, result, 0, arr.size(), course[k]);
	...
	private static void combination(List<Character> arr, List<Character> result, int index, int n, int r) {
...
//		System.out.println(solution(orders1, course1));		// ["AC", "ACDE", "BCFG", "CDE"]
//		System.out.println(solution(orders2, course2));		// ["ACD", "AD", "ADE", "CD", "XYZ"]
		System.out.println(solution(orders3, course3));		// ["WX", "XY"]
